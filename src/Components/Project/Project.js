  ...
  return (
    ...
    >
      <>
                ...
                <div className='flex flex-col overflow-auto  space-y-3 my-3 mx-1 w-full md:w-5/12 '>
                  ...
                  <div className='w-auto flex space-x-5 relative'>
                    <a href={project.github} target='_blank' rel='noreferrer'>
                      <img src='./images/icons/github.svg' alt='link to github page' style={{ width: '24px', height: '24px' }} />
                    </a>
                    <a href={project.link} target='_blank' rel='noreferrer'>
                      <img src='./images/icons/external-link.svg' alt='link to live website' style={{ width: '24px', height: '24px' }} />
                    </a>
                    {(project.apkLink) ?
                      <a href={project.apkLink} target='_blank' rel='noreferrer'>
                        <img src='./images/icons/apk.svg' alt='link to apk' style={{ width: '24px', height: '24px', filter: 'invert(100%) sepia(35%) saturate(2%) hue-rotate(142deg) brightness(114%) contrast(101%)' }} />
                      </a> : null}
        ...
        <div className='mx-5'>
          <a href='https://github.com/geekrohan' target='_blank' rel='noreferrer' className='bg-gray block shadow-lg uppercase border border-gray-500 rounded-lg text-center my-12 p-2 max-w-xs m-auto'>
