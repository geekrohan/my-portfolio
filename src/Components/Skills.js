    ...
    >
      <section className='my-28  px-5'>
        ...
        <div className='my-7 grid gap-5 grid-cols-3 md:grid-cols-6'>
          ...
          <div className='flex flex-col items-center' tabIndex='0' role='img' aria-label='Angular'>
            <img src='./images/icons/angular.png' alt='' loading='lazy' className='w-16 mb-1' width='64px' height='64px' />
          Angular
        </div>
          <div className='flex flex-col items-center' tabIndex='0' role='img' aria-label='Ionic'>
            <img src='./images/icons/ionic.svg' alt='' loading='lazy' className='w-16 mb-1' width='64px' height='64px' />
          Ionic
        </div>
          ...
          <div className='flex flex-col items-center' tabIndex='0' role='img' aria-label='Nodejs'>
            <img src='./images/icons/nodejs.png' alt='' loading='lazy' className='w-16 mb-1' width='64px' height='64px' />
          Nodejs
        </div>
          <div className='flex flex-col items-center' tabIndex='0' role='img' aria-label='Stripe'>
            <img src='./images/icons/stripe.png' alt='' loading='lazy' className='w-16 mb-1' width='64px' height='64px' />
          Stripe Integration
        </div>
          <div className='flex flex-col items-center' tabIndex='0' role='img' aria-label='Auth0'>
            <img src='./images/icons/auth0.svg' alt='' loading='lazy' className='w-16 mb-1' width='64px' height='64px' />
          Auth0 Integration
        </div>
