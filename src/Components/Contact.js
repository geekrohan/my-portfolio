                    ...
                    <div className='md:w-6/12 md:px-0 my-1'>
                        ...
                        <div className='flex flex-row flex-wrap mt-7'>
                            <div className='ml-4 md:ml-0 mr-4'>
                                <a href='mailto: rohanjaincode@gmail.com' target='_blank' rel='noreferrer'>
                            ...
                            <div className='ml-4 md:ml-0 mr-4'>
                                <a href='https://www.linkedin.com/in/geekrohan/' target='_blank' rel='noreferrer'>
                                    <span className='mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm'>
                            ...
                            <div className='ml-4 md:ml-0 mr-4'>
                                <a href='https://github.com/geekrohan' target='_blank' rel='noreferrer'>
                                    <span className='mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm'>
